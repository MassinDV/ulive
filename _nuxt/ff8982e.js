(window.webpackJsonp = window.webpackJsonp || []).push([
    [70, 47, 48, 50, 51, 53], {
        ...
        279: function(t, e, r) {
            ...
            (0, r(41).default)("5c482ffc", content, !0, {
                sourceMap: !1
            })
        },
        280: function(t, e, r) {
            ...
            (0, r(41).default)("2fd2ad47", content, !0, {
                sourceMap: !1
            })
        },
        303: function(t, e, r) {
        ...
        353: function(t, e, r) {
            "use strict";
            r.r(e);
            r(15), r(29), r(30), r(46), r(31), r(74), r(104);
            var o = r(267),
                n = r(138),
                l = {
                    props: {
                    ...
                    components: {
                        BtnDefault: function() {
                            return r.e(6).then(r.bind(null, 431))
                        },
                        VideoButton: function() {
                            return Promise.all([r.e(7), r.e(8)]).then(r.bind(null, 432))
                        },
                        Swiper: n.Swiper,
                    ...
                    mounted: function() {
                        this.romanticSlider = this.movieData.filter((function(t) {
                            return 1 == t.romanticSlider
                        }))
                    },
                    methods: {
                ...
                component = Object(c.a)(l, (function() {
                    var t = this,
                        ...
                        r = t._self._c || e;
                    return r("div", {
                        staticClass: "hero-slider group relative"
                    }, [r("div", {
                    ...
                    }, t._l(t.romanticSlider, (function(e, o) {
                        return r("swiper-slide", {
                            key: o,
                            staticClass: "flex items-center tvseries bg-no-repeat bg-cover 2xl:bg-center !h-[380px] md:!h-[450px] lg:!h-[500px] xl:!h-[605px] before:content-[''] before:h-full before:w-full before:absolute before:top-0 before:left-0 tvseries bg-[#000]",
                            class: e.bgColor,
                            style: {
                                "background-image": "url(" + e.posterImage + ")"
                            }
                        }, [r("div", {
                            staticClass: "slider-content ml-4 pr-4 xl:ml-10 2xl:ml-[100px] z-9 relative"
                        }, [r("h1", {
                            staticClass: "title sm:mb-5 mb-3 lg:mb-[30px] lg:text-[80px] sm:text-[50px] text-[36px] font-bold block leading-[1] animation-one text-white",
                            class: e.titleColor
                        }, [t._v(t._s(e.title))]), t._v(" "), r("div", {
                            staticClass: "flex flex-col sm:flex-row sm:items-center animation-two"
                        }, [r("span", {
                            staticClass: "subtitle text-white sm:text-[25px] text-[20px] font-bold sm:mb-0 mb-2"
                        }, [t._v(t._s(e.sliderSubtitle))]), t._v(" "), r("span", {
                            staticClass: "text-white sm:text-[25px] text-[20px] font-bold sm:ml-[15px] sm:pl-[15px] ml-0 relative before:hidden sm:before:block sm:before:content-[''] before:bg-white before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:transform before:h-5 before:w-[1px]"
                        }, [t._v(t._s(e.duration))])]), t._v(" "), r("div", {
                            staticClass: "flex items-center mt-7 sm:mt-10 md:mt-14 animation-three"
                        }, [r("n-link", {
                            staticClass: "inline-block rounded-[3px] transition-all duration-300 sm:py-[15px] sm:px-[25px] px-[20px] py-[10px] bg-[#f4181c] text-white font-semibold hover:bg-white hover:text-[#333333] !text-[16px]",
                            attrs: {
                                to: "/" + t.PageLink + "/" + t.slugify(e.title)
                            }
                        }, [t._v("Watch Now")])], 1)])])
                    })), 1)], 1), t._v(" "), t._m(0)])
                }), [function() {
                    var t = this,
                        ...
                        r = t._self._c || e;
                    return r("div", {
                        staticClass: "hero-slider_arrows flex justify-between w-full absolute top-1/2 -translate-y-1/2 z-99"
                    }, [r("div", {
                        staticClass: "hero-slider_arrows__prevbtn swipper-arrow text-red hover:text-white transition-all duration-300 text-[60px] opacity-0 group-hover:opacity-100 group-hover:ml-5 ml-0"
                    }, [r("i", {
                        staticClass: "zmdi zmdi-chevron-left bold-important"
                    })]), t._v(" "), r("div", {
                        staticClass: "hero-slider_arrows__nextbtn swipper-arrow text-red hover:text-white transition-all duration-300 text-[60px] opacity-0 group-hover:opacity-100 group-hover:mr-5 mr-0"
                    }, [r("i", {
                        staticClass: "zmdi zmdi-chevron-right bold-important"
                    })])])
                }], !1, null, "37b41bc8", null);
            e.default = component.exports
        },
        354: function(t, e, r) {
            "use strict";
            ...
            var o = r(267),
                ...
                l = {
                    ...
                    mounted: function() {
                        this.comboPackSlider = this.movieData.filter((function(t) {
                            return 1 == t.comboPackSlider
                        }))
                    },
                    methods: {
                        slugify: function(text) {
                ...
                component = Object(c.a)(l, (function() {
                    ...
                    }, t._l(t.comboPackSlider, (function(e, o) {
                        return r("swiper-slide", {
                            key: o,
                            staticClass: "flex items-center tvseries bg-no-repeat bg-cover 2xl:bg-center !h-[380px] md:!h-[450px] lg:!h-[500px] xl:!h-[605px] before:content-[''] before:h-full before:w-full before:absolute before:top-0 before:left-0 tvseries bg-[#000]",
                            class: e.bgColor,
                            ...
                            staticClass: "flex items-center animation-two"
                        }, [r("span", {
                            staticClass: "subtitle text-red text-[25px] lg:text-[35px] font-bold"
                        }, [t._v(t._s(e.newprice))]), t._v(" "), r("span", {
                            staticClass: "ml-5 subtitle text-white text-[25px] lg:text-[35px] font-bold relative before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-full\n                         before:h-[2px] before:bg-white"
                        }, [t._v(t._s(e.oldprice))])]), t._v(" "), r("div", {
                            staticClass: "flex items-center mt-7 sm:mt-10 md:mt-14 animation-three"
                        }, [r("n-link", {
                            staticClass: "inline-block rounded-[3px] transition-all duration-300 sm:py-[15px] sm:px-[25px] px-[20px] py-[10px] bg-[#f4181c] text-white font-semibold hover:bg-white hover:text-[#333333] !text-[16px]",
                            attrs: {
        ...
        416: function(t, e, r) {
            ...
            var o = {
                    components: {
                        ...
                        HeroOne: function() {
                            return Promise.resolve().then(r.bind(null, 353))
                        },
                        HeroTwo: function() {
                            return Promise.resolve().then(r.bind(null, 354))
                        },
                        SeriesBannerOne: function() {
                            return Promise.all([r.e(1), r.e(18)]).then(r.bind(null, 446))
                        },
                        RecentMovie: function() {
                            return r.e(87).then(r.bind(null, 410))
                        },
                        OldMovie: function() {
                            return r.e(89).then(r.bind(null, 409))
                        },
                        WatchWithFamilyMovie: function() {
                            return r.e(90).then(r.bind(null, 411))
                        },
                        AwardedMovie: function() {
                            return r.e(88).then(r.bind(null, 408))
                        },
                ...
                component = Object(n.a)(o, (function() {
                    ...
                    }, [r("RecentMovie")], 1), t._v(" "), r("div", {
                        staticClass: "container-fluid px-4 xl:px-10 2xl:px-[100px] pt-[50px] bg-[#000000]"
                    }, [r("HorrorSeries")], 1), t._v(" "), r("div", {
                        staticClass: "container-fluid px-4 xl:px-10 2xl:px-[100px] py-[50px] bg-[#000000]"
                    }, [r("OldMovie")], 1), t._v(" "), r("HeroTwo", {
                        attrs: {
                            PageLink: "movie"
                        }
                    }), t._v(" "), r("div", {
                        staticClass: "container-fluid px-4 xl:px-10 2xl:px-[100px] py-[50px] bg-[#000000]"
                    }, [r("WatchWithFamilyMovie")], 1), t._v(" "), r("SeriesBannerOne", {
                        attrs: {
                            PageLink: "series"
                        }
                    }), t._v(" "), r("div", {
                        staticClass: "container-fluid px-4 xl:px-10 2xl:px-[100px] py-[50px] bg-[#000000]"
                    }, [r("AwardedMovie")], 1), t._v(" "), r("div", {
            ...
            e.default = component.exports;
            installComponents(component, {
                HeroOne: r(353).default,
                HeroTwo: r(354).default,
